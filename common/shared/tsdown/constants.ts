...
export const PRESET_UMD_ENTRY_FILE = 'src/main.ts';
export const FACADE_ENTRY_FILE = 'src/facade/index.ts';
export const LOCALE_DIRECTORIES = ['src/locale', 'src/locales'] as const;
export const SOURCE_DIRECTORY = 'src';
export const WORKER_ENTRY_FILE = 'src/worker.ts';
